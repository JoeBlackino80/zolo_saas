      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          <a href="mailto:support@zolo.sk" className="bg-white border border-slate-200 rounded-xl p-5 hover:shadow-md hover:border-blue-300 transition group">
            <div className="w-10 h-10 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center mb-3"><Mail size={20} /></div>
          ...
          <a href="mailto:privacy@zolo.sk" className="bg-white border border-slate-200 rounded-xl p-5 hover:shadow-md hover:border-blue-300 transition group">
            <div className="w-10 h-10 rounded-lg bg-purple-100 text-purple-600 flex items-center justify-center mb-3"><Mail size={20} /></div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6">
          ...
          <div className="text-sm text-slate-600 space-y-1">
            ...
            <div>Web: <a href="https://app2.zolo.sk" className="text-blue-600 hover:underline">app2.zolo.sk</a></div>
          </div>
