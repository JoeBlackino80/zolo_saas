...
export default function NewBankAccountPage() {
  ...
  return (
    <div className="p-8 max-w-2xl">
      <Link href="/dashboard/bank-accounts" className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-900 mb-3"><ArrowLeft size={14} /> Späť</Link>
      <PageHeader title="Nový bankový účet" />
