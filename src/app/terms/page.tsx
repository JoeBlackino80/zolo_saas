  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 prose prose-slate">
        <h1 className="text-3xl font-bold text-slate-900 tracking-tight mb-2">Obchodné podmienky</h1>
        <p className="text-sm text-slate-500 mb-8">Účinné od 15. júna 2026</p>

        <section className="space-y-6 text-slate-700 leading-relaxed">
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">1. Úvodné ustanovenia</h2>
            <p>Prevádzkovateľom služby ZOLO (ďalej len &ldquo;Služba&rdquo;) je <strong>Prevádzkovateľ</strong> (kontaktné údaje na <Link href="/contact" className="text-blue-600 hover:underline">stránke kontaktu</Link>). Tieto obchodné podmienky upravujú práva a povinnosti zmluvných strán pri používaní Služby.</p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">2. Definícia služby</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">3. Registrácia a prístup</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">4. Cenové podmienky</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">5. Práva a povinnosti používateľa</h2>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">6. Dostupnosť služby</h2>
            <p>Prevádzkovateľ sa snaží zabezpečiť maximálnu dostupnosť (SLA 99% v beta režime). Plánované odstávky budú vopred oznámené.</p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">7. Spracovanie údajov</h2>
            <p>Spracovanie osobných údajov sa riadi samostatným dokumentom <Link href="/privacy" className="text-blue-600 hover:underline">Ochrana osobných údajov</Link>.</p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">8. Zodpovednosť za škodu</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">9. Ukončenie</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">10. Záverečné ustanovenia</h2>
        ...
        <div className="mt-12 pt-6 border-t border-slate-200 text-sm text-slate-500 flex gap-4">
          <Link href="/privacy" className="hover:text-blue-600">Ochrana osobných údajov</Link>
