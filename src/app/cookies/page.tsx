  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold text-slate-900 tracking-tight mb-2">Cookies politika</h1>
        <p className="text-sm text-slate-500 mb-8">Účinné od 15. júna 2026</p>

        <section className="space-y-6 text-slate-700 leading-relaxed">
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">1. Čo sú cookies</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">2. Aké cookies používame</h2>
            <p>ZOLO používa <strong>iba nevyhnutné cookies</strong> potrebné pre fungovanie Služby:</p>
            <table className="w-full mt-4 text-sm border border-slate-200 rounded">
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">3. Tracking cookies</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">4. Ako spravovať cookies</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">5. Zmeny politiky</h2>
