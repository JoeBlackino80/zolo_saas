  ...
  },
  {
    ...
    items: [
      ...
      { icon: Wallet, label: 'Pokladnica', href: '/dashboard/cash-book', segments: ['cash-book'],
        children: [
          { label: 'Pohyby (denník)',        href: '/dashboard/cash-book' },
          { label: 'Príjem hotovosti (PPD)',  href: '/dashboard/cash-book/quick?type=cash_receipt' },
          { label: 'Výdaj hotovosti (VPD)',    href: '/dashboard/cash-book/quick?type=cash_payout' },
          { label: 'Rozšírený doklad',        href: '/dashboard/cash-book/new' },
        ],
      },
